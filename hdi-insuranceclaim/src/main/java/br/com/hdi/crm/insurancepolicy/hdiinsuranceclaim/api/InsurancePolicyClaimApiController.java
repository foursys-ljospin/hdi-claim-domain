...
public class InsurancePolicyClaimApiController implements InsurancePolicyClaimApi {
	...
	public ResponseEntity<?> getInsuranePolicyClaimOrders(
			...
			@ApiParam(value = "insurancepolicy ID", required = true) @PathVariable("idInsurancePolicy") String idInsurancePolicy,
			@ApiParam(value = "Claim ID", required = true) @PathVariable("idClaim") String idClaim,
		...
		if (accept != null && accept.contains("application/json")) {
			try {
				if (false)
					...
					List<Order> orders = 
							this.claimOrderService.findOrdersByPolicyAndClaimPageable(idInsurancePolicy, idClaim, limit, skip);
			...
			try {
				if (false)
					...
					List<InsurancePolicyClaimPayment> payments =
							this.claimPaymentService.findPaymentsByPolicyAndClaimPageable(idInsurancePolicy, idClaim, limit, skip);
